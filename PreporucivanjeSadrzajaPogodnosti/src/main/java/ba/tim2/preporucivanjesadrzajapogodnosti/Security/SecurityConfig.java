...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers(POST, "/filmovi/**").permitAll()
                // Clanarina
                .requestMatchers(GET, "/clanarine/**").hasRole("ADMIN")
                .requestMatchers(POST, "/clanarine/**").hasRole("ADMIN")
                .requestMatchers(PUT, "/clanarine/**").hasRole("ADMIN")
                .requestMatchers(DELETE, "/clanarine/**").hasRole("ADMIN")
                // Film
